      ...
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold mb-4">
              Sagar <span className="text-blue-400">Sharma</span>
            </h3>
            <p className="text-gray-300 mb-6 max-w-md">
              A full-stack developer dedicated to creating innovative solutions 
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>Khar(E), Mumbai - 400051</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex items-start">
                ...
                <span>sharmasagar01@outlook.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-center items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Sagar Sharma. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
